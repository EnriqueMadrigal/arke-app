...
public class ObrasAdapter extends RecyclerView.Adapter<ObrasAdapter.ViewHolder> {
    ...
    private ArrayList<Obra> _items;
    private IViewHolderClick _listener;
    private Bitmap _placeHolder;
    Integer row_index = -1;

    public ObrasAdapter(Context context, ArrayList<Obra> items, IViewHolderClick listener) {
        _context = context;
        _items = items;
        _listener = listener;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(_context).inflate(R.layout.obras_items, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        Obra curObra = _items.get(position);
        holder.get_labelName().setText(curObra.get_name());
        holder.get_labelDesc().setText(curObra.get_desc());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View view, IViewHolderClick listener) {
            ...
            _labelName = (TextView) view.findViewById(R.id.lblNameObraItem);
            _labelDesc = (TextView) view.findViewById(R.id.lblDescObraItem);
            _linearLayout = (LinearLayout) view.findViewById(R.id.LinearObraItem);
            _imageIcon = (ImageView) view.findViewById(R.id.ImgObraItem);
